...
class FileTypeConfig:
    ...
    )  # Regex patterns for path-based detection
    display_name: str = ""
...
class FileTypeRegistry:
    ...
    _extension_map: Dict[str, List[Tuple[FileTypeConfig, int]]] = (
        {}
    )  # ext -> [(config, priority)]
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    security_checks=["Hardcoded secrets", "Sensitive data exposure"],
                    common_issues=[
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    performance_tips=["Minimize file size", "Avoid excessive nesting"],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    security_checks=["External resource URLs", "Interpolation safety"],
                    common_issues=[
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    performance_tips=["Minimal dependencies", "Hash checking"],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    performance_tips=["Vendoring for CI", "Module proxy"],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    style_guidelines=["Group organization", "Consistent formatting"],
                    performance_tips=["Parallel installation", "Cache optimization"],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    security_checks=["Test credential exposure", "Unsafe mocking"],
                    common_issues=[
                        "Coverage thresholds",
                    ...
                    performance_tips=["Parallel execution", "Selective testing"],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    style_guidelines=["Section organization", "Comments for clarity"],
                    performance_tips=[],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    style_guidelines=["Organized sections", "Comments for clarity"],
                    performance_tips=["Minimize build context", "Exclude test files"],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    style_guidelines=["Alphabetical organization", "Comment sections"],
                    performance_tips=[],
                ),
            )
        )
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    ...
                    style_guidelines=["Extends vs rules", "Organized overrides"],
                    performance_tips=["Cache usage", "Ignore patterns"],
                ),
            )
        )
    ...
    def _register_generic(cls) -> None:
        ...
        cls._register(
            FileTypeConfig(
                ...
                best_practices=BestPractices(
                    focus_areas=["Code clarity", "Error handling", "Documentation"],
                    security_checks=[
                    ...
                    performance_tips=["Efficient algorithms", "Resource management"],
                ),
            )
        )
    ...
    def classify(cls, file_path: str) -> FileCategory:
        ...
        for config in sorted(
            cls._configs.values(), key=lambda c: c.priority, reverse=True
        ):
            for pattern in config.path_patterns:
                try:
                    ...
                    logger.warning(
                        "invalid_regex_pattern", pattern=pattern[:50], error=str(e)
                    )
                    continue
        ...
        # Fallback to generic
        logger.debug("file_classified_as_generic", path=file_path[:100])
        return FileCategory.GENERIC
    ...
    def get_best_practices(cls, category: FileCategory) -> BestPractices:
        ...
        return cls._configs.get(
            ...
            FileTypeConfig(category=FileCategory.GENERIC, extensions=[]),
        ).best_practices
    ...
    def format_best_practices_for_prompt(
        cls, categories: List[FileCategory], max_practices: int = 20
    ) -> str:
        """
